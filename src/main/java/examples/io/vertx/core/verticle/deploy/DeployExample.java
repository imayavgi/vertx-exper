package examples.io.vertx.core.verticle.deploy;
...
public class DeployExample extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    vertx.deployVerticle("OtherVerticle", new DeploymentOptions().setConfig(config));

    // Deploy 10 instances
    vertx.deployVerticle("OtherVerticle", new DeploymentOptions().setInstances(10));

    // Deploy it as a worker verticle
    vertx.deployVerticle("OtherVerticle", new DeploymentOptions().setWorker(true));
